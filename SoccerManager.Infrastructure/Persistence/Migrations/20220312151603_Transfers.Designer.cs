...
namespace SoccerManager.Infrastructure.Persistence.Configurations.Migrations
{
    ...
    [Migration("20220312151603_Transfers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoccerManager.Application.Entities.TransferItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SoccerManager.Application.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SoccerManager.Application.Entities.SoccerPlayer", b =>
                {
                    ...
                    b.HasOne("SoccerManager.Application.Entities.TransferItem", "TransferItem")
                        .WithOne("SoccerPlayer")
                        .HasForeignKey("SoccerManager.Application.Entities.SoccerPlayer", "TransferItemId");
